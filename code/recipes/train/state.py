...
def main(args):
    ...
    train_file, dev_file, test_file = [json.load(open(data_path, 'r')) for data_path in ['data/recipes/train.json', 'data/recipes/dev.json', 'data/recipes/test.json']]
