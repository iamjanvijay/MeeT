...
def main(answers_file: str, predictions_file: str, output_file: str, diagnostics_file: str, sentences_file: str, only_return_f1: bool):
    ...
    if only_return_f1:
        return round(evaluation.overall.F1(), 4)
...
if __name__ == '__main__':
    ...
    main(args.answers_file, args.predictions_file, args.output_file, args.diagnostics_file, args.sentences_file, False)
